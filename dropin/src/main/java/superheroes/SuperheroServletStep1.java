...
@WebServlet(name = "SuperheroServletStep1", urlPatterns = {"/step1", "/step1/status"})
public class SuperheroServletStep1 extends HttpServlet {
		
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	Payabbhi.accessId = UserDetails.Access_ID;
    	Payabbhi.secretKey = UserDetails.Secret_key;
    	String morderid = "JAVASDK-dropin-Step1-Order-" + (int)(Math.random()*10000);
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/step1/index.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/step1/status.jsp");
	    dispatcher.forward(request, response);
	}
}