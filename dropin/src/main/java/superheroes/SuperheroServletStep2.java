...
@WebServlet(name = "SuperheroServletStep2", urlPatterns = {"/step2", "/step2/status"})
public class SuperheroServletStep2 extends HttpServlet {
		
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	Payabbhi.accessId = UserDetails.Access_ID;
    	Payabbhi.secretKey = UserDetails.Secret_key;
    	String morderid = "JAVASDK-dropin-Step2-Order-" + (int)(Math.random()*10000);
    	
    	HashMap<String, Object> params = new HashMap<String, Object>();
    	params.put("merchant_order_id",(String)morderid);
    	params.put("amount", (int)1000);
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/step2/index.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/step2/status.jsp");
	    dispatcher.forward(request, response);
	}
}