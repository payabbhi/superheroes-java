...
@WebServlet(name = "SuperheroServletStep4", urlPatterns = {"/step4", "/step4/status"})
public class SuperheroServletStep4 extends HttpServlet {
		
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	Payabbhi.accessId = UserDetails.Access_ID;
    	Payabbhi.secretKey = UserDetails.Secret_key;
    	String morderid = "JAVASDK-dropin-Step4-Order-" + (int)(Math.random()*10000);
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/step4/index.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/step4/status.jsp");
		dispatcher.forward(request, response);
	}
}