      ...
      <div class="site-wrapper-inner">
       ...
       <% if (paymentid != null) { %>
         <div class="inner cover">
              ...
              <p class="lead">
                <a href="${pageContext.request.contextPath}/step1" class="btn btn-lg btn-default">Continue shopping</a>
              </p>
         </div>          
       ...
       <% } else { %>
              ...
              <p class="lead">
                <a href="${pageContext.request.contextPath}/step1" class="btn btn-lg btn-default">Try Again</a>
              </p>
            </div>
